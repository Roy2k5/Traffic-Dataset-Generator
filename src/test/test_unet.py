...
test_unet.py
============
Evaluate UNet on the test split (images 1000–1199).
...
Output written to: src/test/unet_results.txt

Run from project root:
    python src/test/test_unet.py
"""
...
RESULT_PATH = os.path.join(ROOT, 'src', 'test', 'unet_results.txt')
...
def main():
    ...
    lines = [
        '=== UNet Segmentation Test Results ===',
